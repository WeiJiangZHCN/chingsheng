...
<template>
  <div
    :class="
      cn(
        `group relative flex size-full overflow-hidden rounded-sm border bg-neutral-100 text-black dark:bg-neutral-900 dark:text-white`,
        $props.class,
      )
    "
  ...
  >
    ...
    <div
      class="pointer-events-none absolute inset-0 rounded-sm opacity-0 transition-opacity duration-300 group-hover:opacity-100"
      :style="{
